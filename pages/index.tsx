...
const Home: NextPage<Props> = ({
  ...
  return (
    <div className='!scrollbar-thin !scrollbar-track-transparent !scrollbar-thumb-red-600 relative h-screen bg-gradient-to-b from-gray-900/10 to-[#010511] lg:h-[140vh] overflow-x-hidden'>
      <Head>
